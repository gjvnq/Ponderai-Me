...
const MaxScript = "nota_final = max(array_de_notas)"
const MinScript = "nota_final = min(array_de_notas)"
const CrazyScript = "nota_final = p1 + p2 - 3*sqrt(p3)"
...
func TestRunScriptMin(t *testing.T) {
}

func TestRunScriptCrazy(t *testing.T) {
}